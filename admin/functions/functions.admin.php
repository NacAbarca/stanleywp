...
function optionsframework_admin_message() {
    ...
    jQuery(function(){
        ...
        var message = '<p>Este tema viene con un <a href="<?php echo admin_url('admin.php?page=optionsframework'); ?>">panel de opciones</a> para configurar ajustes. Este tema también admite widgets, visite el <a href="<?php echo admin_url('widgets.php'); ?>">página de configuración de widgets</a> para configurarlos.</p>';
