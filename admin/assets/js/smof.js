...
jQuery(document).ready(function($){
	...
	// event.preventDefault();
	var agree = confirm("¿Estás seguro de que deseas eliminar esta diapositiva?");
		if (agree) {
	...
	$('#of_backup_button').live('click', function(){
		...
		var answer = confirm("Haga clic en Aceptar para hacer una copia de seguridad de sus opciones guardadas actuales.")
	...
	$('#of_restore_button').live('click', function(){
		...
		var answer = confirm("'Advertencia: ¡Todas sus opciones actuales serán reemplazadas por los datos de su última copia de seguridad! ¿Proceder?")
	...
	$('#of_import_button').live('click', function(){
		...
		var answer = confirm("Haga clic en Aceptar para importar opciones.")
	...
	$('#of_reset').click(function() {
		...
		//confirm reset
		var answer = confirm("Haga clic en Aceptar para reiniciar. ¡Todas las configuraciones se perderán y se reemplazarán con las configuraciones predeterminadas!");
