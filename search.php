...
?>
                <header>
                <h1 class="search-page-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf(__('Vínculo permanente a %s', 'gents'), the_title_attribute('echo=0')); ?>"><?php echo $title; ?></a></h1>
                </header>

                <section class="post-entry">
                    <?php the_content(__('Leer más &raquo;', 'gents')); ?>
                    <?php wp_link_pages(array('before' => '<div class="pagination">' . __('Pagínas:', 'gents'), 'after' => '</div><!-- end of .pagination -->')); ?>
                </section><!-- end of .post-entry -->

                <footer class="article-footer">
                <div class="post-data">
					<?php edit_post_link(__('Editar', 'gents'), '', ' &#124; '); ?>
					<?php comments_popup_link(__('Sin comentarios <i class="icon-arrow-down"></i>', 'gents'), __('1 comentario <i class="icon-arrow-down"></i>', 'gents'), __('% Comentarios <i class="icon-arrow-down"></i>', 'gents')); ?>
